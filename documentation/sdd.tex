...
IEEE-formatted \LaTeX\ sources. Implementation follows milestones M1--M6
(\texttt{documentation/milestones.tex}); each milestone updates structure,
design docs, and runnable behavior.
